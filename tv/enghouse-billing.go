...
*/
func EnghouseRequest(accountdata EngTrans) {
	var err error
...
*/
//		Changed to recognize Cert from EngHouse
...
func EnghouseAccount(CoreDB *mongo.Database, accountcode string, subscribecode string) (accountdata EngTrans, err error) {
	...
	subscribe := telmax.GetSubscribe(CoreDB, accountcode, subscribecode)
	...
	for _, channel := range channels {
		productData := telmax.GetProduct(CoreDB, "product_code", channel.ProductCode)
	...
	for _, device := range devices {
		accountdata.Devices = append(accountdata.Devices, EngDevice{
